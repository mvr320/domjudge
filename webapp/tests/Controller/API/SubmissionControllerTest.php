...
use App\DataFixtures\Test\RemoveTeamFromPlaceholderUserFixture;
...
class SubmissionControllerTest extends BaseTest
{
    ...
    {
        yield ['placeholder', [], "One of the arguments 'problem', 'problem_id' is mandatory"];
        yield ['placeholder', ['problem' => 1], "One of the arguments 'language', 'language_id' is mandatory"];
        yield ['placeholder', ['problem_id' => 1], "One of the arguments 'language', 'language_id' is mandatory"];
        yield ['placeholder', ['problem_id' => 4, 'language' => 'cpp'], "Problem 4 not found or not submittable"];
        yield ['placeholder', ['problem_id' => 1, 'language' => 'cpp'], "No files specified."];
        yield ['placeholder', ['problem_id' => 1, 'language_id' => 'cpp'], "No files specified."];
        yield ['placeholder', ['problem_id' => 1, 'language' => 'abc'], "Language abc not found or not submittable"];
        yield ['placeholder', ['problem_id' => 1, 'language_id' => 'abc'], "Language abc not found or not submittable"];
        yield ['placeholder', ['problem_id' => 1, 'language_id' => 'abc'], "Language abc not found or not submittable"];
        yield ['placeholder', ['problem_id' => 1, 'language_id' => 'cpp', 'team_id' => 1], "Can not submit for a different team"];
        yield ['placeholder', ['problem_id' => 1, 'language_id' => 'cpp', 'id' => '123'], "A team can not assign id"];
        yield ['placeholder', ['problem_id' => 1, 'language_id' => 'cpp', 'time' => '2021-01-01T00:00:00'], "A team can not assign time"];
        yield ['placeholder', ['problem_id' => 1, 'language_id' => 'cpp', 'files' => []], "The 'files' attribute must be an array with a single item, containing an object with a base64 encoded data field"];
        yield [
            'placeholder',
    ...
    public function testMissingEntryPoint()
    {
        ...
        $contestId = $this->demoContest->getCid();
        $apiEndpoint = $this->apiEndpoint;
        $data = $this->verifyApiJsonResponse('POST', "/contests/$contestId/$apiEndpoint", 400, 'placeholder', ['problem_id' => 1, 'language' => 'kotlin']);
    ...
    {
        $this->loadFixtures([RemoveTeamFromPlaceholderUserFixture::class, RemoveTeamFromAdminUserFixture::class]);
